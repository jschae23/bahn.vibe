            ...
            <div className="space-y-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-blue-600">
                        Durchsuche {searchParams.dayLimit || "3"} Tage für die besten Preise zwischen {searchParams.start} und{" "}
                        {searchParams.ziel}
                    </p>
                </div>
                <LoadingSpinner />
        ...
        <div className="space-y-6">
            ...
            <div>
                <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
                    📅 Preiskalender
                    <span className="text-sm font-normal text-gray-500">(Klicken für Tagesübersicht)</span>
                </h3>
                <PriceCalendar
